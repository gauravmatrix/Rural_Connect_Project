  ...
  `}function w(){return C(`
    ...
    <section id="services" class="mt-8 scroll-mt-32">
      <header class="reveal text-center">
        <p class="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold tracking-[0.08em] text-[#2563EB]">Features</p>
        <h2 class="mx-auto mt-3 max-w-3xl text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl">Powerful Features for Smart Rural Governance</h2>
        <p class="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-slate-600 sm:text-base">Empowering citizens and authorities with a seamless, transparent, and efficient grievance resolution system.</p>
      </header>

      <div class="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ${g.map((e,t)=>`
          <article class="feature-card reveal glass-card p-6" style="transition-delay:${Math.min(t*70,280)}ms;">
            <span class="feature-icon-wrap">${y(e.icon)}</span>
