import{a as e,i as t,n,o as r,r as i,t as a}from"./vendor-CycBfz5f.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var o=r.create({baseURL:`https://api.ruralconnect.gov.in`,timeout:15e3});o.interceptors.request.use(e=>{let t=localStorage.getItem(`rc_token`);return t&&(e.headers.Authorization=`Bearer ${t}`),e});var s=e=>e?.response?.data?.message||e?.response?.data?.error||e?.message||`Something went wrong`,c=async e=>{let{data:t}=await o.post(`/api/v1/auth/register`,e);return t},l=async e=>{let{data:t}=await o.post(`/api/v1/auth/verify-otp`,e);return t},u=async e=>{let{data:t}=await o.post(`/api/v1/auth/login`,e);return t},d=document.querySelector(`#app`),f=`rc_otp_email`,p=`rc_pending_section`,m,h=[{image:`/images/rural/rural-family.png`,heading:`Empowering Rural Voices`,subheading:`A digital platform connecting citizens with authorities for faster grievance resolution.`},{image:`/images/rural/digital-plan.png`,heading:`Digital Governance for Villages`,subheading:`Bringing transparency, accountability, and efficiency to rural administration.`},{image:`/images/rural/sustainable-developemnt.png`,heading:`Supporting Rural Development`,subheading:`Address issues related to water, roads, farming, and essential services.`},{image:`/images/rural/digital-classroom.png`,heading:`Building Better Futures`,subheading:`Improving quality of life through timely resolution of public issues.`}],g=[{title:`Water Supply`,description:`Issues related to water taps, pipelines, and availability`,image:`/images/rural/water-tap.png`},{title:`Street Lighting`,description:`Faulty or missing street lights in villages`,image:`/images/rural/street-light.png`},{title:`Road Infrastructure`,description:`Damaged roads, potholes, and construction issues`,image:`/images/rural/rural-road.png`},{title:`Sewage & Sanitation`,description:`Drainage problems and sanitation concerns`,image:`/images/rural/water-canal.png`},{title:`Government Schemes`,description:`Issues related to ration cards, Awaas Yojna, etc.`,image:`/images/rural/rural-healthcare.png`},{title:`Education`,description:`School infrastructure, classroom facilities, and learning support issues`,image:`/images/rural/school-children.png`}],_=[{title:`Raise Complaint`,description:`Citizen submits issue with details and media proof.`,icon:`file-text`},{title:`Pradhan Review`,description:`Local authority reviews and takes action.`,icon:`users`},{title:`Verification & Resolution`,description:`Issue is inspected and resolved within timeline.`,icon:`check-circle`},{title:`Escalation (If Needed)`,description:`If unresolved, it automatically escalates to district level.`,icon:`alert-triangle`}],v=[{label:`Complaints Resolved`,value:1e4,suffix:`+`,description:`Successfully resolved issues across villages`,icon:`analytics`},{label:`Active Users`,value:5e3,suffix:`+`,description:`Citizens actively using the platform`,icon:`users`},{label:`Villages Connected`,value:200,suffix:`+`,description:`Rural areas benefiting from digital governance`,icon:`home`},{label:`Avg Resolution Time`,value:5,suffix:` Days`,prefix:`3-`,description:`Faster response and resolution`,icon:`clock`}];function y(e){let t={analytics:`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"></path><path d="M7 15l4-4 3 3 5-6"></path></svg>`,"file-text":`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"></path></svg>`,clock:`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`,home:`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10.5 12 3l9 7.5"></path><path d="M5 9.5V21h14V9.5"></path><path d="M9 21v-6h6v6"></path></svg>`,users:`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`,"check-circle":`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12l2 2 4-4"></path><circle cx="12" cy="12" r="10"></circle></svg>`,"alert-triangle":`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>`,"message-circle":`<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.5 8.5 0 0 1-8.5 8.5H7l-4 3v-6.5A8.5 8.5 0 1 1 21 11.5z"></path></svg>`};return t[e]||t[`file-text`]}function b(e){return y(e)}var x=[{id:`home`,label:`Home`},{id:`about`,label:`About`},{id:`services`,label:`Services`},{id:`community`,label:`Community`},{id:`contact`,label:`Contact`}];function S(){return`
        ...
        <div class="mt-3 flex h-[76px] items-center justify-between rounded-2xl border border-white/50 bg-white/65 px-4 shadow-[0_10px_38px_-20px_rgba(37,99,235,0.45)] backdrop-blur-xl transition-all duration-300 sm:px-5 lg:h-[84px] lg:px-6">
          <a href="#/" class="logo-glow group flex items-center gap-3 transition duration-300 hover:scale-[1.03]">
            <span class="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-[#2563EB] to-[#F97316] text-white shadow-[0_10px_18px_-12px_rgba(37,99,235,0.8)]">
              <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 10.5 12 3l9 7.5"></path><path d="M5 9.5V21h14V9.5"></path><path d="M9 21v-6h6v6"></path></svg>
            </span>
            <span class="text-xl font-extrabold tracking-tight">
              <span class="text-[#F97316]">Rural</span>
              <span class="text-[#2563EB]">Connect</span>
            </span>
          </a>
  ...
  `}function C(e){return`
    ${S()}
    <div class="mx-auto w-full max-w-[92rem] px-4 pb-10 pt-28 sm:px-6 lg:px-6 lg:pt-32 xl:px-8">
      ${e}
    </div>
  `}function w(){return C(`
    <section id="home" class="scroll-mt-32">
      <div class="hero-swiper swiper rise-in relative mx-auto w-full overflow-hidden rounded-[1.6rem] lg:w-[68%] xl:w-[66%]">
          ...
          ${h.map(e=>`
            <article class="swiper-slide relative h-[90vh] min-h-[540px]">
              ...
              <div class="absolute inset-0 flex items-end md:items-center">
                <div class="hero-slide-content mx-auto flex w-full max-w-6xl flex-col items-center px-5 pb-16 text-center sm:px-7 md:items-start md:pb-0 md:text-left lg:px-10">
        ...
        <div class="grid items-center gap-7 lg:grid-cols-[1fr_1.08fr] lg:gap-10">
          <div class="reveal reveal-left">
            <div class="grid gap-4">
              ...
              <figure class="about-image-wrap group relative ml-auto w-full overflow-hidden rounded-2xl sm:w-[82%]">
      ...
      <div class="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ${g.map((e,t)=>`
          <article class="service-card reveal group relative overflow-hidden rounded-2xl" style="transition-delay:${Math.min(t*70,280)}ms;">
            ...
            <div class="service-bottom-tint service-tint-${t%6+1} absolute inset-x-0 bottom-0 h-[34%]"></div>
    ...
    <section id="impact" class="mt-10 scroll-mt-32">
      <div class="glass-card p-6 sm:p-8 lg:p-10">
        ...
        <div class="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ${v.map((e,t)=>`
            <article class="impact-card impact-card-${t%4+1} reveal rounded-2xl border border-white/70 bg-white/85 p-6 text-center shadow-[0_16px_36px_-24px_rgba(15,23,42,0.45)] backdrop-blur" style="transition-delay:${Math.min(t*80,320)}ms;">
    ...
    <section id="community" class="mt-10 scroll-mt-32">
      <div class="glass-card overflow-hidden p-6 sm:p-8 lg:p-10">
        <div class="grid items-start gap-7 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          <article class="reveal reveal-left">
            <p class="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold tracking-[0.08em] text-[#2563EB]">Community</p>
            <h2 class="mt-4 text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl">Connect, Discuss, and Raise Issues Together</h2>

            <p class="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
              Rural Connect offers a community platform where villagers can come together, discuss common issues, and raise concerns collectively.
            </p>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 sm:text-base">
              Just like a group chat, citizens can share problems, interact with others, and bring attention to critical issues affecting the entire village.
            </p>
            <p class="mt-3 text-sm leading-relaxed text-slate-600 sm:text-base">
              This ensures faster action, better awareness, and stronger community engagement.
            </p>

            <ul class="mt-6 grid gap-2 sm:grid-cols-2">
              <li class="community-point">Real-time discussion among villagers</li>
              <li class="community-point">Share common problems</li>
              <li class="community-point">Engage directly with local authorities</li>
              <li class="community-point">Increase awareness and collective action</li>
            </ul>

            <div class="mt-7">
              <a href="#/register" class="hero-btn-primary">Join Community</a>
            </div>
          </article>
          ...
          <aside class="reveal reveal-right">
            <div class="community-chat-card">
              <header class="community-chat-header">
                <div class="community-avatar">VC</div>
                <div>
                  <p class="text-sm font-bold text-slate-900">Village Community</p>
                  <p class="text-xs text-slate-500">128 members online</p>
                </div>
              </header>

              <div class="mt-5 space-y-3">
                <div class="chat-row is-citizen chat-seq" style="transition-delay:60ms;">
                  <span class="chat-avatar">C</span>
                  <div class="chat-bubble chat-citizen">Street light is not working</div>
                </div>

                <div class="chat-row is-citizen chat-seq" style="transition-delay:180ms;">
                  <span class="chat-avatar">C</span>
                  <div class="chat-bubble chat-citizen">Same issue near school</div>
                </div>

                <div class="chat-row is-pradhan chat-seq" style="transition-delay:320ms;">
                  <span class="chat-avatar pradhan">P</span>
                  <div class="chat-bubble chat-pradhan">We will inspect tomorrow</div>
                </div>

                <div class="chat-typing chat-seq" style="transition-delay:420ms;">
    ...
    <section id="cta" class="mt-10 scroll-mt-32">
      <div class="reveal overflow-hidden rounded-[1.8rem] bg-gradient-to-r from-[#2563EB] via-[#2A6CF0] to-[#F97316] px-6 py-12 text-center shadow-[0_24px_46px_-26px_rgba(37,99,235,0.7)] sm:px-10 sm:py-14">
        <p class="text-xs font-semibold uppercase tracking-[0.13em] text-white/90">Get Started Today</p>
        <h2 class="mx-auto mt-3 max-w-3xl text-3xl font-extrabold leading-tight text-white sm:text-4xl">Raise Your Voice. Get Your Issues Resolved.</h2>
        <p class="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-blue-50 sm:text-base">Join Rural Connect and experience transparent, fast, and efficient grievance resolution.</p>
        <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <a href="#/register" class="hero-btn-primary text-base">Raise Complaint</a>
          <a href="#/verify-otp" class="rounded-full border border-white px-7 py-3 text-base font-semibold text-white transition hover:scale-105 hover:bg-white hover:text-[#1e293b]">Track Complaint</a>
        </div>
      </div>
    </section>
    ...
    <section id="contact" class="mt-10 scroll-mt-32">
      <div class="glass-card p-6 sm:p-8 lg:p-10">
        <header class="reveal mb-6 text-center">
          <h2 class="text-3xl font-extrabold text-slate-900 sm:text-4xl">Contact Us</h2>
        </header>

        <div class="grid gap-6 lg:grid-cols-[1fr_1.05fr]">
          <article class="reveal reveal-left rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
            <h3 class="text-xl font-bold text-slate-900">Reach Our Support Team</h3>
            <p class="mt-2 text-sm text-slate-600">We are here to help citizens and local authorities with platform usage and grievance workflow support.</p>

            <div class="mt-6 space-y-3">
              <div class="contact-item">
                <span class="contact-item-icon">✉</span>
                <a class="text-sm font-medium text-slate-700 hover:text-[#F97316]" href="mailto:support@ruralconnect.in">support@ruralconnect.in</a>
              </div>
              <div class="contact-item">
                <span class="contact-item-icon">☎</span>
                <a class="text-sm font-medium text-slate-700 hover:text-[#F97316]" href="tel:+919876543210">+91 9876543210</a>
              </div>
              <div class="contact-item items-start">
                <span class="contact-item-icon">⌂</span>
                <p class="text-sm font-medium text-slate-700">District Office, Haryana, India</p>
              </div>
            </div>
          </article>

          <form id="contactForm" class="reveal reveal-right rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
            <div class="grid gap-4">
              ...
              <textarea class="field min-h-32" name="message" placeholder="Your Message" required></textarea>
              <button id="contactSubmitBtn" type="submit" class="hero-btn-primary w-full sm:w-auto">Send Message</button>
              <p id="contactMsg" class="text-sm"></p>
            </div>
          </form>
        </div>
      </div>
    ...
    <footer class="mt-10 overflow-hidden rounded-t-[1.8rem] bg-[#0b1220] text-slate-200">
      <div class="grid gap-8 px-6 py-10 sm:px-8 lg:grid-cols-3 lg:px-10">
        <div>
          <h3 class="text-2xl font-extrabold text-white">Rural Connect</h3>
          <p class="mt-3 max-w-sm text-sm leading-relaxed text-slate-400">Digital-first governance platform for transparent grievance resolution and stronger rural engagement.</p>
          <div class="mt-4 flex items-center gap-3">
            <a href="#" aria-label="Facebook" class="footer-social">f</a>
            <a href="#" aria-label="X" class="footer-social">x</a>
        ...
        <div>
          <h4 class="text-base font-bold text-white">Contact Info</h4>
          <div class="mt-4 space-y-2 text-sm text-slate-400">
            <p>support@ruralconnect.in</p>
            <p>+91 9876543210</p>
            <p>District Office, Haryana, India</p>
          </div>
        </div>
      </div>

      <div class="border-t border-slate-800 px-6 py-4 text-xs text-slate-400 sm:flex sm:items-center sm:justify-between sm:px-8 lg:px-10">
        <p>© 2026 Rural Connect. All rights reserved.</p>
